...
# Generated On: 5/11/2017 3:21 PM
...
$groupBoxWhy = New-Object System.Windows.Forms.GroupBox
$txtBoxWhy = New-Object System.Windows.Forms.TextBox
   ...
   #ConfirmImpact = 'High',
    ...
    if ($PSCmdlet.ShouldProcess($user,"Enabling User")) {
       ...
       Enable-ADAccount -Identity $User -Server 'scedr07dc001.ce.rt.ru';
            ...
            [System.Windows.Forms.MessageBox]::Show("Изменения не проведены. У вас не хватает прав.");break;
            }
    
            if (($user|get-aduser -Properties enabled,description -Server 'scedr07dc001.ce.rt.ru').enabled -eq $true)
                {
                  Set-ADObject -Identity $User -replace @{msExchHideFromAddressLists=$false} -Server 'scedr07dc001.ce.rt.ru';
                  Set-ADObject -Identity $User -replace @{description="Причина: $global:why. Дата: $Global:Date"} -Server 'scedr07dc001.ce.rt.ru';
                  #Set-ADObject -Identity $User -Clear 'description' -Server 'scedr07dc001.ce.rt.ru';
                  $groups = ((get-aduser -Identity $User  -Properties userParameters -Server 'scedr07dc001.ce.rt.ru'| select userparameters).userparameters) -split ";"
...
# Присваиваем переменной $Name значение из поля ФИО
       ...
       $global:why=$txtBoxWhy.Text;
    
    if(
    $global:existADUsers=Get-ADUser -Properties EmployeeID,enabled,mail,userParameters,UserPrincipalName -LDAPFilter "((ANR=$Global:Name))" -SearchBase "dc=ce,dc=rt,dc=ru" -Server "scedr07dc001.ce.rt.ru" | where {$_.enabled -eq $false}
    ...
    $OUTPUT= [System.Windows.Forms.MessageBox]::Show("Найден пользователь:`n$($global:existAduser.name)`nEmail:`n$($global:existAduser.mail)`nEmployeeID:`n$($global:existAduser.employeeid)`nDistinguishedname:`n$($global:existAduser.distinguishedname)`nРазблокировать УЗ?" , "Status" , 4) 
        if ($OUTPUT -eq "YES" ) 
            ...
            $LOGoutput= "$($Global:Date);$($global:existAduser.name);$($global:existAduser.UserPrincipalName);$($Global:Account_owner);$($global:why)"
            $LOGoutput | out-file "C:\!Scripts\UnBlockUser\Log\CE_Восстановленные_УЗ_Posh.csv" -Append -Encoding utf8 -Force
            break; 
            }
        if ($OUTPUT -eq "NO" ) 
            {
...
$groupBoxWhy.DataBindings.DefaultDataSourceUpdateMode = 0
$System_Drawing_Point = New-Object System.Drawing.Point
$System_Drawing_Point.X = 15
$System_Drawing_Point.Y = 103
$groupBoxWhy.Location = $System_Drawing_Point
$groupBoxWhy.Name = "groupBoxWhy"
$System_Drawing_Size = New-Object System.Drawing.Size
$System_Drawing_Size.Height = 60
$System_Drawing_Size.Width = 290
$groupBoxWhy.Size = $System_Drawing_Size
$groupBoxWhy.TabIndex = 7
$groupBoxWhy.TabStop = $False
$groupBoxWhy.Text = "Причина разблокировки"

$grpBoxUserInformation.Controls.Add($groupBoxWhy)
$txtBoxWhy.DataBindings.DefaultDataSourceUpdateMode = 0
$System_Drawing_Point = New-Object System.Drawing.Point
$System_Drawing_Point.X = 7
$System_Drawing_Point.Y = 20
$txtBoxWhy.Location = $System_Drawing_Point
$txtBoxWhy.Name = "txtBoxWhy"
$System_Drawing_Size = New-Object System.Drawing.Size
$System_Drawing_Size.Height = 20
$System_Drawing_Size.Width = 270
$txtBoxWhy.Size = $System_Drawing_Size
$txtBoxWhy.TabIndex = 0

$groupBoxWhy.Controls.Add($txtBoxWhy)
